...
const BYOK_API_KEYS = [
  ...
  // Writely writing-assistant providers (OpenAI-compatible chat completions).
  {
    ...
    storeKey: "deepseekApiKey",
  },
  {
    base: "fireworks",
    env: "FIREWORKS_API_KEY",
    get: "getFireworksKey",
    save: "saveFireworksKey",
    storeKey: "fireworksApiKey",
  },
  {
    base: "together",
    env: "TOGETHER_API_KEY",
    get: "getTogetherKey",
    save: "saveTogetherKey",
    storeKey: "togetherApiKey",
  },
  {
    base: "minimax",
    env: "MINIMAX_API_KEY",
    get: "getMinimaxKey",
    save: "saveMinimaxKey",
    storeKey: "minimaxApiKey",
  },
  {
    base: "perplexity",
    env: "PERPLEXITY_API_KEY",
    get: "getPerplexityKey",
    save: "savePerplexityKey",
    storeKey: "perplexityApiKey",
  },
  {
    base: "cohere",
    env: "COHERE_API_KEY",
