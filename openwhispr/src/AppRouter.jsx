    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 animate-[scale-in_300ms_ease-out]">
        <svg
          ...
          aria-label="Writely"
        >
          <rect width="1024" height="1024" rx="241" fill="#2563EB" />
          <path d="M250 700 L350 320 L450 620 L512 450 L574 620 L674 320 L774 700" stroke="white" strokeWidth="72" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
